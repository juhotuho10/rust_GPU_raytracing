...
pub(crate) fn define_render_scene() -> RenderScene {
    ...
    let object_vec = load_stl_files(&[
        ...
        ObjectCreation {
            file_path: "./3D_models/Knight.stl",
            scale: 2.0,
        ...
        ObjectCreation {
            file_path: "./3D_models/Bishop.stl",
            scale: 2.0,
