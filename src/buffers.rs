...
// Structs moved to scene.rs; re-exported so existing import paths keep working.
pub use crate::scene::{
    ObjectInfo, Params, Ray, RayCamera, SceneMaterial, SceneSphere, SceneTriangle, SubObjectInfo,
};
